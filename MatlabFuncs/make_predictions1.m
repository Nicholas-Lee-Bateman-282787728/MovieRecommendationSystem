...
% This computes distances of each collected movie against each input movie,
% and then considers the minimum distance for each. Doesn't seem to be
% working very well, so trying combinedInput.
