function [ finalResults ] = batch_test(sM, sD, k, predictionMethod, inputAmount, outputAmount)
...
for i = 1:numberOfTestCases
    ...
    [accuracy, recMovies, numberOfInputs] = single_user_test(i, sM, sD, k, outputAmount, predictionMethod, inputAmount);
    finalResults(i,1) = i;
